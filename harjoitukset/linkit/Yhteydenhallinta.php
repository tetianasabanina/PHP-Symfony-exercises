...
class YhteydenHallinta {
    ...
    private function avaaYhteys(){
        ...
        try {
            ...
            $this->yhteys = new PDO('mysql:host=localhost;dbname=harjoitukset', $kayttaja, $salasana);
